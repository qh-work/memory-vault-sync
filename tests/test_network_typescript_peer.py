...
class TypeScriptPeerTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for name in ("crypto.ts", "content.ts", "hints.ts", "control.ts", "nodes.ts", "records.ts", "vault.ts", "privacy.ts", "io.ts", "transport.ts", "peer.ts", "setup.ts", "retrieval.ts", "retrieval_text.ts", "ranking_math.ts", "package.json"):

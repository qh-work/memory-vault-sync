...
class NetworkPackagingTests(unittest.TestCase):
    ...
    def test_new_sdk_docs_and_review_fixtures_are_explicit_public_paths(self):
        ...
        self.assertTrue({"tests/test_open_delivery_http.py", "tests/test_open_provider_typescript.py",
                         ...
                         "tests/test_open_repair_wire.py", "tests/test_open_repair_typescript.py"} <= set(review))
        ...
        self.assertTrue({"tests/test_network_hints.py", "tests/test_network_hints_typescript.py",
                         ...
                         "tests/test_network_received_batch_recall_typescript.py", "tests/test_network_relay_pool.py",
                         "tests/test_network_relay_pool_typescript.py"} <= set(review))
        self.assertIn("docs/NETWORK_TYPESCRIPT.md", documents)
        self.assertIn("docs/NETWORK_TYPESCRIPT.md", protocol)
        for name in ("docs/EXPERIENCE_SEMANTICS.md", "docs/EXPERIENCE_VALIDATION.md", "docs/NETWORK_CONTENT_V2.md", "docs/NETWORK_HINTS_V1.md", "docs/NETWORK_HINTS_V2.md", "docs/NETWORK_HINTS_V3.md", "docs/NETWORK_HINTS_V4.md", "docs/RECEIVED_BATCH_RECALL.md", "docs/RELAY_POOL.md"):
            self.assertIn(name, documents)
            self.assertIn(name, protocol)
        ...
        self.assertTrue({"tests/test_network_trial.py", "tests/test_network_trial_coordinator.py",
                         "tests/test_network_trial_packaging.py"} <= set(review))

"""Public synthetic v0.21 verifier vectors adapted to the v0.25 archive profile.

Not executed during development. Test RSA integers have no production authority.
No real Vault, private key, account or installed plugin is used.
"""
...
import memory_vault_update_trust as signed_updates  # noqa: E402
from memory_vault_update_trust import (  # noqa: E402
    jcs_json_bytes,
    sha256_bytes,
)
        ...
        "targets": {
            signed_updates.TARGET_PATH: {
                ...
                "custom": {
                    ...
                    "plugin_name": "memory-vault-client",
                    "plugin_version": observed["version"],
                    "source_commit_sha": (
                        signed_commit or observed["commit_sha"]
                    ),
                    "protocol": {
                        "minimum": protocol[0],
                        "maximum": protocol[1],

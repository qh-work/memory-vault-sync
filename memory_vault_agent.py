...
def definitions() -> list[dict[str, Any]]:
    ...
    descriptions = {
        ...
        "send": "Queue encrypted chat, an explicitly selected memory closure, or one recipient-bound Hint query/page/select control (select one to four seen roots within one query). Chat, notes and controls never become memories automatically. Stored is not understood.",
...
class Agent:
    ...
    def discovery(self) -> dict[str, Any]:
        ...
        return {"profile": PROFILE, "role": "trusted_endpoint", "operations": list(OPERATIONS),
                ...
                "hint_profile": "memory-vault-hint/v3",

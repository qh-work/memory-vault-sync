...
REQUIRED_MODULES = (
    ...
    "memory_vault_compat.py", "memory_vault_experience.py",
    ...
    "memory_vault_network_content.py", "memory_vault_network_hints.py",
...
PACKAGE_DOCUMENTS = (
    ...
    "docs/VISIBLE_FRAGMENTS.md", "docs/EXPERIENCE_SEMANTICS.md", "docs/EXPERIENCE_VALIDATION.md", "scripts/demo_experience.py",
    ...
    "requirements-network.txt", "requirements-network-server.txt", "docs/NETWORK_V1.md", "docs/NETWORK_CONTENT_V2.md", "docs/NETWORK_HINTS_V1.md", "docs/NETWORK_HINTS_V2.md", "docs/NETWORK_HINTS_V3.md", "docs/NETWORK_HINTS_V4.md", "docs/RECEIVED_BATCH_RECALL.md", "docs/RELAY_POOL.md", "docs/NETWORK_QUICKSTART.md",
    ...
    "clients/typescript/network/peer.ts", "clients/typescript/network/content.ts", "clients/typescript/network/hints.ts", "clients/typescript/network/records.ts",
    "clients/typescript/network/transport.ts", "clients/typescript/network/vault.ts", "clients/typescript/network/privacy.ts",

...
PACKAGE_DOCUMENTS = (
    ...
    "requirements-network.txt", "requirements-network-server.txt", "docs/NETWORK_V1.md", "docs/NETWORK_CONTENT_V2.md", "docs/NETWORK_HINTS_V1.md", "docs/NETWORK_HINTS_V2.md", "docs/NETWORK_HINTS_V3.md", "docs/NETWORK_HINTS_V4.md", "docs/RECEIVED_BATCH_RECALL.md", "docs/NETWORK_QUICKSTART.md",

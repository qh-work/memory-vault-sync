...
REQUIRED_MODULES = (
    ...
    "memory_vault_network_content.py",
...
PACKAGE_DOCUMENTS = (
    ...
    "requirements-network.txt", "requirements-network-server.txt", "docs/NETWORK_V1.md", "docs/NETWORK_CONTENT_V2.md", "docs/NETWORK_QUICKSTART.md",
    ...
    "clients/typescript/network/peer.ts", "clients/typescript/network/content.ts", "clients/typescript/network/records.ts",

...
PROTOCOL_DOCUMENTS = (
    ...
    "docs/NETWORK_V1.md", "docs/NETWORK_CONTENT_V2.md", "docs/NETWORK_HINTS_V1.md", "docs/NETWORK_HINTS_V2.md", "docs/NETWORK_HINTS_V3.md", "docs/NETWORK_HINTS_V4.md", "docs/RECEIVED_BATCH_RECALL.md", "docs/NETWORK_QUICKSTART.md", "docs/NATIVE_DRIVE.md", "docs/RELEASE_NOTES_V0_26_ALPHA.md",
    "docs/V0_26_PLAN.md",
...
NETWORK_REVIEW_TESTS = (
    ...
    "tests/test_network_hints.py", "tests/test_network_hints_typescript.py", "tests/test_network_hints_recovery.py",
    "tests/test_network_hints_pagination.py", "tests/test_network_hints_pagination_typescript.py",
    "tests/test_network_hints_batch.py", "tests/test_network_hints_batch_typescript.py",
    "tests/test_network_hints_cancellation.py", "tests/test_network_hints_cancellation_typescript.py",
    "tests/test_network_received_batch_recall.py", "tests/test_network_received_batch_recall_typescript.py",
    "tests/test_network_message_semantics.py", "tests/test_network_message_typescript.py",
